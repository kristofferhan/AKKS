...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   // Set the content of the activity to use the activity_main.xml layout file
        ...
        TextView reserver = (TextView) findViewById(R.id.activity_booking);
*/
...
/*        // Set a click listener on that View
        reserver.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent reserverIntent = new Intent(.this, ReserverActivity.class);
...
*/
   ...
   /*     // Find the View that shows the bookinger categoty
        TextView bookinger = (TextView) findViewById(R.id.activity_bookinger);
        ...
        bookinger.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent bookingerIntent = new Intent(Reservering.this, Reservering.class);
 ...
 /*       // Find the View that shows the lokaler category
        TextView lokaler = (TextView) findViewById(R.id.activity_lokaler);
*/
...
/*        // Set a click listener on that View
        lokaler.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent lokalerIntent = new Intent(Reservering.this, LokalerActivity.class);
  ...
  /*
        ...
        TextView om = (TextView) findViewById(R.id.activity_om);
*/
  /*      // Set a click listener on that View
        om.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent omIntent = new Intent(Reservering.this, OmActivity.class);
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("Hjem")
                //
                .setUrl(Uri.parse("http://www.akks.no/"))
                .build();
